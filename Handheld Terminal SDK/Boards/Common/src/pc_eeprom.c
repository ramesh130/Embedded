...
u8 I2C_EEReadMemory(uint8_t* pBuffer, uint16_t ReadAddr, uint16_t NumByteToRead)
{
	vu16 NumByte = NumByteToRead;
	sEE_ReadBuffer(pBuffer, ReadAddr, (uint16_t *)(&NumByte));
...
u8 I2C_EEWriteMemory(uint8_t* pBuffer, uint16_t WriteAddr, uint16_t NumByteToWrite)
{
